...
<html>
    ...
    <body>
        <div class="container">
            <form role="form" class="form-horizontal" action="/patient/add" method="post">
                        <h3>New contact</h3>
                        <select class="selectpicker form-control form-group" name="doctor">
                            <option value="-1">Default</option>

                            <c:forEach items="${doctor}" var="group">
